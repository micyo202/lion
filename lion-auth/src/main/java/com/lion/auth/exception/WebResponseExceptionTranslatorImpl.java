...
/**
 * WebResponseExceptionTranslatorImpl
 * 异常翻译
 *
...
public class WebResponseExceptionTranslatorImpl implements WebResponseExceptionTranslator {
    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        if (ase instanceof AccessDeniedException) {
            return handleOAuth2Exception(new WebResponseExceptionTranslatorImpl.ForbiddenException(ase.getMessage(), ase));
        }

        ase = (HttpRequestMethodNotSupportedException) throwableAnalyzer.getFirstThrowableOfType(
                HttpRequestMethodNotSupportedException.class, causeChain);
        if (ase instanceof HttpRequestMethodNotSupportedException) {
            return handleOAuth2Exception(new WebResponseExceptionTranslatorImpl.MethodNotAllowed(ase.getMessage(), ase));
        }
